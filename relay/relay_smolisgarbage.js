...
function isSong(skillOrEffect) {
  if (skillOrEffect instanceof external_kolmafia_.Effect && skillOrEffect.attributes.includes("song")) {
    ...
    return skill.class === template_string_$class(_templateObject || (_templateObject = _taggedTemplateLiteral(["Accordion Thief"]))) && skill.buff;
  }
}
/**
...
function increment(property) {
  ...
  return property_set(property, nextValue);
}
/**
...
function combat_get() { if (typeof Reflect !== "undefined" && Reflect.get) { combat_get = Reflect.get.bind(); } else { combat_get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return combat_get.apply(this, arguments); }
...
var Macro = /*#__PURE__*/function () {
  ...
  combat_createClass(Macro, [{
     ...
     */
    function save() {
      property_set(Macro.SAVED_MACRO_PROPERTY, this.toString());
    }
    /**
...
var StrictMacro = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_Macro) {
  ...
  combat_createClass(StrictMacro, [{
    ...
    function skill() {
      ...
      return (_get2 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "skill", this)).call.apply(_get2, [this].concat(skills));
    }
    /**
     * Create a new macro with one or more skill cast steps.
     *
    ...
    function item() {
      ...
      return (_get3 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "item", this)).call.apply(_get3, [this].concat(items));
    }
    /**
     * Create a new macro with one or more item steps.
     *
    ...
    function trySkill() {
      ...
      return (_get4 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "trySkill", this)).call.apply(_get4, [this].concat(skills));
    }
    /**
     * Create a new macro with one or more skill cast steps, where each step checks if you have the skill first.
     *
    ...
    function tryItem() {
      ...
      return (_get5 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "tryItem", this)).call.apply(_get5, [this].concat(items));
    }
    /**
     * Create a new macro with one or more item steps, where each step checks to see if you have the item first.
     *
    ...
    function trySkillRepeat() {
      ...
      return (_get6 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "trySkillRepeat", this)).call.apply(_get6, [this].concat(skills));
    }
    /**
     * Create a new macro with one or more skill-cast-and-repeat steps, where each step checks if you have the skill first.
     *
...
function maximizeCached(objectives) {
  ...
  var cacheKey = [objective].concat(maximize_toConsumableArray(untouchedSlots.map(slot => "".concat(slot, ":").concat((0,external_kolmafia_.equippedItem)(slot))).sort()), [lib_have(template_string_$effect(_templateObject49 || (_templateObject49 = maximize_taggedTemplateLiteral(["Offhand Remarkable"]))))]).join("; ");
...
function permOptions(planning) {
  ...
  ? perm_defaultPermList().map(sks => sks.filter(sk => !(sk.toString() in getPermedSkills()) && (have(sk) || gnomeSkills.includes(sk) && gnomadsAvailable() || classChoices.includes(sk.class) && sk.level > 0))) //for current run, include skills that we know or that we can train in this run.
  : perm_defaultPermList().map(sks => sks.filter(sk => !(sk.toString() in getPermedSkills() || ctPerms.includes(sk)) && (gnomeSkills.includes(sk) || classChoices.includes(sk.class) && sk.level >= 0))); //for next run, exclude all skills that we are planning to perm this run, and allow all guild and gnome skills.
}
...
function expectedKarma(planning) {
  return (!planning ? get("bankedKarma") + (inHardcore() ? 200 : inCasual() ? 0 : 100) : expectedKarma(false) - perm_targetPerms(false).length * 100 + (inHardcore() ? 200 : inCasual() ? 0 : 100)) + (args.astralpet === $item(perm_templateObject11 || (perm_templateObject11 = perm_taggedTemplateLiteral(["none"]))) ? 10 : 0);
}
...
function perm_targetClass(planning) {
  if (myClass() === $class(perm_templateObject12 || (perm_templateObject12 = perm_taggedTemplateLiteral(["Grey Goo"])))) {
...
function perm_targetPerms(planning) {
  ...
  var tClass = planning ? perm_targetClass(true) : $class(perm_templateObject15 || (perm_templateObject15 = perm_taggedTemplateLiteral(["none"])));
  return (!planning ? pOptions.flat().filter(sk => !gnomeSkills.includes(sk) || gnomadsAvailable()) :
...
function famValue(fam, mob) {
  switch (fam) {
    case $familiar(utils_templateObject3 || (utils_templateObject3 = utils_taggedTemplateLiteral(["Red-Nosed Snapper"]))):
      if (mob && Snapper.getTrackedPhylum() && mob.phylum === Snapper.getTrackedPhylum()) return garboValue(Snapper.phylumItem.get(Snapper.getTrackedPhylum() || $phylum(utils_templateObject4 || (utils_templateObject4 = utils_taggedTemplateLiteral(["none"])))) || $item(utils_templateObject5 || (utils_templateObject5 = utils_taggedTemplateLiteral(["none"])))) / 11;
      return 0;
    case $familiar(utils_templateObject6 || (utils_templateObject6 = utils_taggedTemplateLiteral(["Cookbookbat"]))):
      return $items(utils_templateObject7 || (utils_templateObject7 = utils_taggedTemplateLiteral([""]))).find(it => it.name.indexOf("Recipe of Before Yore") >= 0 && have(it)) ? garboAverageValue.apply(void 0, utils_toConsumableArray($items(utils_templateObject8 || (utils_templateObject8 = utils_taggedTemplateLiteral(["Yeast of Boris, Vegetable of Jarlsberg, St. Sneaky Pete's Whey"]))))) * (3.0 / 11) : 5000;
    case $familiar(utils_templateObject9 || (utils_templateObject9 = utils_taggedTemplateLiteral(["Shorter-Order Cook"]))):
      return garboAverageValue.apply(void 0, utils_toConsumableArray($items(utils_templateObject10 || (utils_templateObject10 = utils_taggedTemplateLiteral(["short white, short beer, short glass of water, short stack of pancakes, short stick of butter"]))))) / 11;
  }
  return 0;
}
function meatFam() {
...
function bestFam(mob) {
  var fams = $familiars(utils_templateObject13 || (utils_templateObject13 = utils_taggedTemplateLiteral(["Grey Goose, Red-Nosed Snapper, Cookbookbat, Shorter-Order Cook"]))).filter(fam => have(fam)).sort((a, b) => famValue(b, mob) - famValue(a, mob));
  return fams.find(fam => have(fam));
}
function canDiet() {
  return myFullness() < fullnessLimit() || mySpleenUse() < spleenLimit() || myInebriety() < inebrietyLimit() || have($item(utils_templateObject14 || (utils_templateObject14 = utils_taggedTemplateLiteral(["distention pill"])))) && !get("_distentionPillUsed") || have($item(utils_templateObject15 || (utils_templateObject15 = utils_taggedTemplateLiteral(["synthetic dog hair pill"])))) && !get("_syntheticDogHairPillUsed") || have($item(utils_templateObject16 || (utils_templateObject16 = utils_taggedTemplateLiteral(["designer sweatpants"])))) && get("_sweatOutSomeBoozeUsed") < 3 && get("sweat") >= 25 || have($item(utils_templateObject17 || (utils_templateObject17 = utils_taggedTemplateLiteral(["mime army shotglass"])))) && !get("_mimeArmyShotglassUsed") || get("currentMojoFilters") < 3 && mallPrice($item(utils_templateObject18 || (utils_templateObject18 = utils_taggedTemplateLiteral(["mojo filter"])))) + mallPrice($item(utils_templateObject19 || (utils_templateObject19 = utils_taggedTemplateLiteral(["transdermal smoke patch"])))) < 2.5 * get("valueOfAdventure");
}
function stooperDrunk() {
  return myInebriety() > inebrietyLimit() || myInebriety() === inebrietyLimit() && myFamiliar() === $familiar(utils_templateObject20 || (utils_templateObject20 = utils_taggedTemplateLiteral(["Stooper"])));
}
function totallyDrunk() {
  return have($familiar(utils_templateObject21 || (utils_templateObject21 = utils_taggedTemplateLiteral(["Stooper"])))) && myFamiliar() !== $familiar(utils_templateObject22 || (utils_templateObject22 = utils_taggedTemplateLiteral(["Stooper"]))) ? myInebriety() > inebrietyLimit() + 1 : myInebriety() > inebrietyLimit();
}
function doneAdventuring() {
  return !canDiet() && myAdventures() === 0 || stooperDrunk();
}
function backstageItemsDone() {
  return (have($item(utils_templateObject23 || (utils_templateObject23 = utils_taggedTemplateLiteral(["giant marshmallow"])))) ? 1 : 0) + (have($item(utils_templateObject24 || (utils_templateObject24 = utils_taggedTemplateLiteral(["beer-scented teddy bear"])))) ? 1 : 0) + itemAmount($item(utils_templateObject25 || (utils_templateObject25 = utils_taggedTemplateLiteral(["gin-soaked blotter paper"])))) >= 2 && (have($item(utils_templateObject26 || (utils_templateObject26 = utils_taggedTemplateLiteral(["booze-soaked cherry"])))) ? 1 : 0) + (have($item(utils_templateObject27 || (utils_templateObject27 = utils_taggedTemplateLiteral(["comfy pillow"])))) ? 1 : 0) + itemAmount($item(utils_templateObject28 || (utils_templateObject28 = utils_taggedTemplateLiteral(["sponge cake"])))) >= 2;
}
var gardens = template_string_$items(utils_templateObject29 || (utils_templateObject29 = utils_taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores, packet of rock seeds"])));
function getGarden() {
  return gardens.find(it => it.name in getCampground()) || $item(utils_templateObject30 || (utils_templateObject30 = utils_taggedTemplateLiteral(["none"])));
}
var banishes;
...
function relay_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
...
function convertArgsToHtml() {
  ...
  pages.filter(p => p.components.length > 0).forEach(p => {
    var html = {
      type: "html",
      data: "<h1 style=\"text-align: center;\">smolisgarbage ".concat(p.page, "</div>")
    };

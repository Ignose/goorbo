...
function GyouQuests() {
  return [{
    ...
    tasks: [{
      ...
      completed: () => !lib_have(template_string_$skill(_templateObject126 || (_templateObject126 = smol_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject127 || (_templateObject127 = smol_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject128 || (_templateObject128 = smol_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject129 || (_templateObject129 = smol_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject130 || (_templateObject130 = smol_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject131 || (_templateObject131 = smol_taggedTemplateLiteral(["soap knife"]))))
    }, {
      name: "Tip the Author",
      //disabled by default - must manually discover and enable the flag
      ready: () => args.tip,
      completed: () => !lib_have(template_string_$item(_templateObject132 || (_templateObject132 = smol_taggedTemplateLiteral(["soap knife"])))),

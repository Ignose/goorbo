  ...
  return [{
    ...
    tasks: [{
      ...
      do: () => {
        ...
        if (!property_get("_sobrieTeaUsed", false)) (0,external_kolmafia_namespaceObject.cliExecute)("acquire cuppa sobrie tea; use cuppa sobrie tea");
